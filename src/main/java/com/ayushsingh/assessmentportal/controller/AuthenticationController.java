...
SuccessResponse<UserDto> response=new SuccessResponse<>(AppConstants.SUCCESS_CODE,AppConstants.SUCCESS_MESSAGE,registeredUser);
         return new ResponseEntity<SuccessResponse<UserDto>>(response,HttpStatus.OK);
     }
     @PostMapping("/register/admin")
     public ResponseEntity<SuccessResponse<UserDto>> registerAdminUser(@RequestBody UserDto userDto,@RequestParam(name="key") String key){
